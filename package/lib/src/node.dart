...
class Node implements IBehaviorAware<Node> {
  ...
  external List<T> getDescendants<T extends Node>([bool directDescendantsOnly, UNSUPPORTED[FirstTypeNode|node is T] Function(Node node) predicate]);
  external List<Node> getDescendants([bool directDescendantsOnly, bool Function(Node node) predicate]);
  external List<T> getChildMeshes<T extends AbstractMesh>([bool directDescendantsOnly, UNSUPPORTED[FirstTypeNode|node is T] Function(Node node) predicate]);
  external List<AbstractMesh> getChildMeshes([bool directDescendantsOnly, bool Function(Node node) predicate]);
  external List<T> getChildren<T extends Node>([UNSUPPORTED[FirstTypeNode|node is T] Function(Node node) predicate, bool directDescendantsOnly]);
